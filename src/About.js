        ...
        <div className="card">
          ...
          <div className="contain">
            ...
            <p>
              ...
              in Kharagpur, West Bengal, India. Established in 1951, the
              institute is the first of the IITs to be established and is
              recognised as an Institute of National Importance. In 2019 it was
              awarded the status of Institute of Eminence by the government of
              India.
            </p>
          </div>
        </div>
        ...
        <div className="card">
          ...
          <div className="contain">
            ...
            <p>
              ...
              of IIChE is in the campus of Jadavpur University, Kolkata. The
              organization has 42 regional centers along with 172 student
              chapters spread throughout India.[1] The institution's membership
              comprises academics, professionals from the chemical industry,
        ...
        <div className="card">
          ...
          <div className="contain text-center">
            ...
            <p>
              ...
              deeply involved in activities in the field of Pollution Control,
              Transport Processes, Coal and Petroleum Technology, and Membrane
              Processes.
            </p>
          </div>
        </div>
